                ...
                <ul class="sidebar-nav">					
					...
					<li class="sidebar-item">
						...
						<ul id="receiving" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
							<li class="sidebar-item active"><a class="sidebar-link" href="/production">{messages.production_label}</a></li>
							<li class="sidebar-item active"><a class="sidebar-link" href="/warehouse">{messages.warehouse_label}</a></li>
						</ul>
					</li>
					...
					<li class="sidebar-item">
						...
						<ul id="outgoing" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
							<li class="sidebar-item active"><a class="sidebar-link" href="/sales">{messages.sales_label}</a></li>
